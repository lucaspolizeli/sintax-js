...
/**
 * always that I will work with some date from operational system, mock that
 */
const CURRENT_YEAR = 2021;

// Change the original getFullYear to an other function
...

{
  ...
  // if doesnt has a set method, value will not change
